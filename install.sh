...
for cmd in ai-dev ai-dev-init ai-dev-project-index ai-dev-project-rules ai-dev-query ai-dev-mcp ai-dev-verify; do
...
printf "  Commands: ai-dev, ai-dev-init, ai-dev-project-index, ai-dev-project-rules, ai-dev-query, ai-dev-mcp, ai-dev-verify\n"
