...
description: Creates new Laravel applications using the latest stable Laravel, official Inertia React starter kit, and project rules.
---
...
3. Check the local runtime and package-manager versions.
4. Create the project using the official Laravel installer or official Composer workflow.
5. Select the official React starter kit with Inertia and TypeScript.
6. Confirm the generated application boots, builds, migrates, and passes its initial tests.
7. Add project context documenting the chosen Laravel, PHP, Node.js, React, Inertia, and database versions.
8. Hand off business implementation to the Task Router after the clean baseline is verified.
...
- The official starter kit does not satisfy a material requirement.
