...
## On receiving work
1. Implement the backend task handed to you by `team-lead`: controllers, validation, authorization, services/actions, migrations, and queries, following existing project conventions — thin controllers, transactions where needed, N+1 prevention. Follow `10-minimal-change.mdc`: smallest diff, fewest files.
