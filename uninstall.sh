...
rm -f "$HOME/.local/bin/ai-dev" "$HOME/.local/bin/ai-dev-init" "$HOME/.local/bin/ai-dev-project-index" "$HOME/.local/bin/ai-dev-project-rules" "$HOME/.local/bin/ai-dev-query" "$HOME/.local/bin/ai-dev-mcp"
